...
**Phase 1~10 코드 준비 완료. 이어서 P5-07(일괄 Day 배정), P7-05(장소→비용 자동
집계, `isManual` 보호), P7-06(더치페이), P10-06(RPC)까지 넣었다.**
Supabase 실 연결은 아직 없다 — 아래 [Phase 10 안내](#phase-10--supabase-연동-상태) 참고.
